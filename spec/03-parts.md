...
| E2 | レビュー | `Review` | default; 星 0.5 刻み; メリット/デメリット; 画像あり/なし | `.swell-block-review` | impl |
...
| # | パーツ | コンポーネント | バリアント | 参照 | 状態 |
|---|---|---|---|---|---|
| G1 | フルワイド | `FullWide` | 上下余白 0/20/40/60/80; 内幅 full / container / article; 背景色 | `.swell-block-fullWide` | impl |
